...
runs <- run_tuning(y ~ P, data = train, interaction = F, directory = "Script/Supplementary materials_hyperparameter optimization", units = 2^seq(1,5))
# runs[which.max(runs$metric_val_accuracy),]
saveRDS(runs, "Script/Supplementary materials_hyperparameter optimization/example1.rds")